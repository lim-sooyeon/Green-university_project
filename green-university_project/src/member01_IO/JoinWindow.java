	...
	public JoinWindow() {
		...
		btn_save.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				memberInfo[0] = id.getText();					// ID
				memberInfo[1] = new String(pw.getPassword());	// PW
				memberInfo[2] = email.getText() + emailAddr.getSelectedItem(); // email
				memberInfo[3] = name.getText();					// name
				memberInfo[4] = (String) (year.getSelectedItem()) + month.getSelectedItem() + date.getSelectedItem(); // birth
				memberInfo[5] = phone.getText();					// phone
				memberInfo[6] = (String) gender.getSelectedItem();	// gender
...
//				}
		...
		idCheck.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				{
					if(members.containsKey(id.getText()))
					{
